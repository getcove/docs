...
To start receiving webhook notifications, please provide your webhook endpoint URL to: team@cove.dev
...
You can test your webhook integration by providing a test endpoint to team@cove.dev. We'll help you simulate webhook events to verify your integration.
