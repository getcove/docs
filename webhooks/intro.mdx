...
```json
{
    "time": "2025-02-03T12:12:29-05:00",
    "applicant": {
        "id": "app_123456789",
        "status": "completed"
    },
...
The `applicant.status` field will be one of:

- `pending`: The screening is waiting to begin
- `in_progress`: The screening is currently being processed
- `completed`: The screening has been completed
- `failed`: The screening encountered an error
