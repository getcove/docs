...
### **Example Request**
```sh
curl -X GET https://sandbox-api.getcove.co/v1/flows/steps \
...
By following these steps, you can create a fully customized screening process that fits your specific requirements. This enables more flexible, reusable, and automated tenant screenings.
