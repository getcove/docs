...
```sh
curl -X POST https://sandbox-api.getcove.co/v1/property \
...
```sh
curl -X POST https://sandbox-api.getcove.co/v1/screening/send \
-H "Authorization: your-access-token" \
-H "Content-Type: application/json" \
-H "Accept: application/json" \
-d '{
...
```sh
curl -X GET https://sandbox-api.getcove.co/v1/screening/data/<userId> \
-H "Authorization: your-access-token" \
-H "Accept: application/json"
```
