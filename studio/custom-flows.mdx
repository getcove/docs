...
```sh
curl -X GET https://sandbox-api.cove.dev/v1/flows/steps/list \
...
```sh
curl -X POST https://sandbox-api.cove.dev/v1/flows \
-H "Authorization: your-access-token" \
...
For any questions, reach out to [team@cove.dev](mailto:team@cove.dev).