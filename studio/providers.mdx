...
```
Credit checks are performed through Equifax as primary provider with TransUnion as fallback.
...
| Equifax  | Credit Reports | Credit reports, Mortgage information |
| TransUnion | Credit Reports | Credit reports, Mortgage information |
